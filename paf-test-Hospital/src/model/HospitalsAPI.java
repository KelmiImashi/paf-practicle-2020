...
public class HospitalsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		String output = hospitalObj.insertHospital(     
				...
				request.getParameter("hos_charges")); 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		Map paras = getParasMap(request); 
		 ...
		 String output = hospitalObj.updateHospital(paras.get("hidHidSave").toString(),     
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = hospitalObj.deleteHospital(paras.get("hid").toString()); 
